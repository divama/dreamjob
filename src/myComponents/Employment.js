  ...
  <div>
    ...
    <Accordion exclusive={false}>
      ...
      <Accordion.Content active={true}>
        ...
        and expanding the living style guide. I work with Git, Gulp, Yarn, Npm,
        Less, Scss etc, and am creating an own react component library, which is
        styled with our own Semantic UI custom Theme and available via a CDN
        link to all Exact Cloud Solution developers worldwide. I also support
        other international teams in Exact Cloud solution by creating prototypes
        for them and helping them with other front-end related matters and
        sharing knowledge. Next to that I've recorded 3 knowledge sharing
