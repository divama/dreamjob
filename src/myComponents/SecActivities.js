      ...
      <Accordion.Content>
        <List>
          <List.Item>
            <List.Icon name="book" />
            <List.Content>
              2010 <br />MOSS/WCM SP07 website UMC st.Radboud uitgeroepen tot
          ...
          <List.Item>
            <List.Icon name="book" />
            <List.Content>
              2006 <br />Hands-on training for Flash @ Haagse Hogeschool/TH
              Rijswijk
            </List.Content>
          </List.Item>
          <List.Item>
            <List.Icon name="book" />
            <List.Content>
              2004 - 2005 <br />Kampleider introductiekamp informatica @ Haag
              Uit.
              <br />
              www.haaguit.com
            </List.Content>
