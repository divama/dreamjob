  ...
  <div>
    ...
    <Accordion>
      ...
      <Accordion.Content>
        ...
        Yarn, Npm, Less, Scss etc, and am creating an own react/redux component
        library, which is styled with our own Semantic UI custom Theme and
        available via a CDN link to all Exact Cloud Solution developers. I also
        support other teams in Exact Cloud solution by creating prototypes for
        them and helping them with other front-end related matters and sharing
        knowledge (international). Next to that I've recorded 3 knowledge
        sharing video's about how to use and contribute to the living style
        guide using Git.
      </Accordion.Content>
      ...
      <Accordion.Content>
        ...
        using Html5, Less, Gulp, and WordPress. I also supported other teams in
        Exact Cloud solution by creating prototypes for them and helping them
        with other front-end related matters and sharing knowledge
        (international). Next to that I've implemented Exact's visual langue for
