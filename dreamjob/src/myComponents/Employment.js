            ...
            <List.Item>
              <List.Content>
                <Accordion>
                  ...
                  <Accordion.Content>
                    <List.Description>
                      At Exact we're developing our very own Design System to
                      create a coherent experience across all digital
                      touchpoints at Exact Cloud Solutions. For this I've
                      created a living style guide which is the single point of
                      truth for our product teams at Exact. It speeds up the
                      time they need to develop great software, with this value
                      to our customers is delivered faster. Being Front-end
                      developer in the Exact Design System team means I have the
                      key role in creating, maintaining and expanding the living
                      style guide. I work with Git, Grunt, Gulp, Yarn, Npm,
                      Less, Scss etc, and am creating an own react/redux
                      component library, which is styled with our own Semantic
                      UI custom Theme and available via a CDN link to all Exact
                      Cloud Solution developers. I also support other teams in
                      Exact Cloud solution by creating prototypes for them and
                      helping them with other front-end related matters and
                      sharing knowledge (international). Next to that I've
                      recorded 3 knowledge sharing video's about how to use and
                ...
                <Accordion>
                  ...
                  <Accordion.Content>
                    <List.Description>
                      ...
                      responsible of maintaining the user interface of Exact
                      Online, using Html, Css, Javascript, jQuery and Asp.net.
                      With the focus on user experience I set up an (atomic)
                      design system and build a living style guide for it, using
                      Html5, Less, Gulp, and WordPress. I also supported other
                      teams in Exact Cloud solution by creating prototypes for
                      them and helping them with other front-end related matters
                      and sharing knowledge (international). Next to that I've
                      implemented Exact's visual langue for in-product-messages
                      and -tours, using Evergage, creating templates,
                ...
                <Accordion>
                  ...
                  <Accordion.Content>
                    <List.Description>
                      ...
                      Javascript/JQuery scripts. Ontwikkelen van animaties en
                      flash banners. Animeren en bewerken van video voor web en
                      presentaties. Ontwerpen en ontwikkelen van e-mail
                      hantekeningen en nieuwsbrieven. Ontwikkelen van
                      bladerfolders. Voor klanten zoals Alpha International, BNV
                      Mobility, Compacon, Gezond Transport, Glasgarage,
                      Hillfresh, IMCD, Indal, Lampidee Lucas Bols, Movenience,
                      Roobol SpitsScoren, Tuinmeubelen, Roobol Wonen, TLN, VAT
                      Logistics, VTL. Skills: HTML standards, XHTML, CSS, JS,
                      JQuery, E-mail marketing, Advising, Bannering, Webvideo
                      Tools: FireBug, PixelPerfect, Developers tools, IETab,
                      GTD, PNG-filters, FLV player, ClickTag, QR code
                      Programma's: Dreamweaver, Illustrator, Photoshop, Flash,
